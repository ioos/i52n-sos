...
public class IoosEncoderUtil {
     ...
     */
    public static List<IoosSosObservation> createIoosSosObservations( Encoder<?,?> encoder,
    		List<OmObservation> omObservations ) throws UnsupportedEncoderInputException{
...
//        Map<StationAsset,TimePeriod> stationPeriodMap = new HashMap<StationAsset,TimePeriod>();
        ...
        for( OmObservation sosObs : omObservations ){
            ...
            if( !( aFoi instanceof SamplingFeature ) ){
            	throw new UnsupportedEncoderInputException( encoder, aFoi );            	
            }
            ...
            for (Point point : points ){
                try {
                    ...
                    throw new UnsupportedEncoderInputException(encoder, point);
                }
            ...
            if( !(iObsValue instanceof SingleObservationValue) ){
            	throw new UnsupportedEncoderInputException( encoder, iObsValue );
            }
            ...
            if( !(obsValue instanceof QuantityValue) ){
            	throw new UnsupportedEncoderInputException( encoder, obsValue );            	
            }
